...
export default function BlogId({ data, products }) {
  const textSize = "text-sm sm:text-base md:text-lg"
  return (
    <main className="h-fit flex flex-col items-center">
      <div className="py-32 m-auto w-4/5 sm:w-3/4 md:w-[66%] lg:w-3/5 flex flex-col justify-center items-center max-w-[40rem]">
        <Title title="Profile" />
        ...
        <div className="w-[80%] max-w-[20rem]">
          <p className={`${textSize} text-center p-3`}>Contact: {data.email}</p>
        ...
        <Title title="Skills" />
        <p className="w-[90%] sm:p-4 text-sm">{data.skills}</p>
        <Title title="History" />
